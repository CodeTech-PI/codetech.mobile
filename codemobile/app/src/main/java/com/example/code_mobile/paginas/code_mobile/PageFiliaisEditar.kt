...
fun FiliaisEditar(navController: NavController, modifier: Modifier = Modifier) {
    var status by remember { mutableStateOf("Operante") } // Inicializado com string vazia
    var cep by remember { mutableStateOf("19141010") } // Inicializado com string vazia
    var logradouro by remember { mutableStateOf("Rua Caraibas") } // Inicializado com string vazia
    var bairro by remember { mutableStateOf("Emilio Marengo") } // Inicializado com string vazia
    var cidade by remember { mutableStateOf("São Paulo") } // Inicializado com string vazia
    var estado by remember { mutableStateOf("São Paulo") } // Inicializado com string vazia
    var numero by remember { mutableStateOf("10") } // Inicializado com string vazia
